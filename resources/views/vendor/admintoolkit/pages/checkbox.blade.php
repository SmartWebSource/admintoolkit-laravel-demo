          ...
          <div class="code-viewer mt-4">
            <div class="flex flex-wrap gap-4">
              <div class="flex items-center gap-1.5">
                <input id="checked" class="checkbox" type="checkbox" name="basic-checkbox" checked="true" />
        ...
        <div class="card-body">
          ...
          <div class="code-viewer mt-4">
            <div class="flex flex-wrap gap-4">
              ...
              <div class="flex items-center gap-1.5">
                <input id="checkbox-md" class="checkbox checkbox-md" type="checkbox" name="checkbox-size" />
                <label for="checkbox-md" class="label">Medium</label>
              </div>
              <div class="flex items-center gap-1.5">
                <input id="checkbox-lg" class="checkbox checkbox-lg" type="checkbox" name="checkbox-size" />
            ...
            <div class="flex flex-wrap gap-4">
              <div class="flex items-center gap-1.5">
                <input
                  ...
                  disabled
                />
                <label for="checked-disabled" class="label label-disabled" aria-disabled="true"
              ...
              <div class="flex items-center gap-1.5">
                <input
                  ...
                  disabled
                />
                <label for="unchecked-disabled" class="label label-disabled" aria-disabled="true"
                  >Unchecked Disabled</label
                >
              </div>
            </div>
          </div>
          ...
          <div class="code-viewer mt-4">
            <div class="flex flex-wrap gap-4">
              <label for="checkbox-icon-heart" class="inline-flex text-sm font-medium dark:text-slate-300">
                <div
                  class="rounded-full p-2 text-primary-500 transition-colors duration-150 focus-within:bg-primary-100 hover:bg-primary-100"
                  role="button"
                >
                  <input
                    id="checkbox-icon-heart"
                    class="zero-sr-only peer"
                    type="checkbox"
                    name="checkbox-icon"
                    checked
                  />
              ...
              <label for="checkbox-icon-bookmark" class="inline-flex text-sm font-medium dark:text-slate-300">
                <div
                  class="rounded-full p-2 text-primary-500 transition-colors duration-150 focus-within:bg-primary-100 hover:bg-primary-100"
                  role="button"
                >
                  <input
                    id="checkbox-icon-bookmark"
                    class="zero-sr-only peer"
                    type="checkbox"
                    name="checkbox-icon"
                  />
