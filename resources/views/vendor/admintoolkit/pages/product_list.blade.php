              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Electronics > Accessories</p>
                  </div>
                </div>
              </td>
              <td>APLW001</td>
              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Electronics > Gadget</p>
                  </div>
                </div>
              </td>
              <td>WLHP008</td>
              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Health Care > Body Oil</p>
                  </div>
                </div>
              </td>
              <td>BCCO078</td>
              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Electronics > Laptop</p>
                  </div>
                </div>
              </td>
              <td>MBP098</td>
              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Fashion > Women's Fashion</p>
                  </div>
                </div>
              </td>
              <td>LHB098</td>
              ...
              <td>
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p class="truncate text-xs text-slate-500 dark:text-slate-400">Electronics > Mobile</p>
                  </div>
                </div>
              </td>
              <td>IPPM032</td>
