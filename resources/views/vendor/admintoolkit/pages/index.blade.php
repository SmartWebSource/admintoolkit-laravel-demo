                    ...
                    <div class="flex flex-1 flex-col gap-1">
                        ...
                        <div class="flex flex-wrap items-baseline justify-between gap-2">
                            ...
                            <span class="flex items-center text-xs font-medium text-success-500">
                                <i class="h-3 w-3" stroke-width="3px"
                                    data-feather="arrow-up-right"></i> 1.2%</span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body flex items-center gap-4">
                    ...
                    <div class="flex flex-1 flex-col gap-1">
                        ...
                        <div class="flex flex-wrap items-baseline justify-between gap-2">
                            ...
                            <span class="flex items-center text-xs font-medium text-success-500">
                                <i class="h-3 w-3" stroke-width="3px"
                                    data-feather="arrow-up-right"></i> 3.2%</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div id="chart-wrap" class="flex flex-col justify-between">
                        <div class="flex flex-wrap items-center justify-between gap-3 md:gap-0">
                            ...
                            <div id="store-analytics-chart-legend" class="flex items-center gap-4">
                                <label for="visitors">
                                    <input type="checkbox" id="visitors" class="hidden" checked
                                        value="Visitors" />
                                ...
                                <label for="orders">
                                    <input type="checkbox" id="orders" class="hidden" checked
                                        value="Orders" />
                                    <div class="flex items-center gap-1">
                        ...
                        <div class="col-span-1 space-y-8 self-center md:col-span-2">
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <div class="flex flex-1 flex-col gap-1">
                                    ...
                                    <div class="progress progress-warning progress-sm"
                                        role="progressbar" aria-valuenow="10" aria-valuemin="0"
                                        aria-valuemax="100">
                                        <div class="progress-line">
                                            <div class="progress-line-track">
            ...
            <div class="order-4 col-span-1 space-y-6">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div
                            ...
                            <img src="./images/product8.png" alt="product-img"
                ...
                <div class="card">
                    <div class="card-body flex flex-col gap-2">
                        ...
                        <div
                            class="flex items-center gap-4 rounded-primary bg-slate-50 p-4 dark:bg-slate-900">
                            <img src="./images/product7.png" alt="product-img"
                                class="w-20 rounded-primary bg-white p-2 dark:bg-slate-800" />
                            <div class="flex flex-1 flex-col gap-1">
                ...
                <div class="card-body flex h-full flex-col">
                    ...
                    <div class="mt-auto divide-y dark:divide-slate-600">
                        ...
                        <div class="flex items-center gap-4 py-2">
                            ...
                            <span
                                class="ml-auto flex items-center text-sm font-medium text-success-500"><i
                                    class="h-3 w-3" stroke-width="3px"
                        ...
                        <div class="flex items-center gap-4 py-2">
                            ...
                            <span
                                class="ml-auto flex items-center text-sm font-medium text-danger-500"><i
                                    class="h-3 w-3" stroke-width="3px"
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar1.png" class="avatar-img"
                                                    alt="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar2.png" class="avatar-img"
                                                    alt="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar3.png" class="avatar-img"
                                                    alt="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar4.png" class="avatar-img"
                                                    alt="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar5.png" class="avatar-img"
                                                    alt="avatar-img" />
                                            </div>
                                            <div>
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-8 overflow-x-auto">
                        ...
                        <div class="grid w-full grid-cols-3">
                            <div class="flex items-center gap-2">
                                <div
                                    class="h-[14px] w-[14px] rounded-full border-2 border-primary-500">
                                </div>
                        ...
                        <div class="grid w-full grid-cols-3">
                            <div class="flex items-center gap-2">
                                <div
                                    class="h-[14px] w-[14px] rounded-full border-2 border-success-500">
                                </div>
                        ...
                        <div class="grid w-full grid-cols-3">
                            <div class="flex items-center gap-2">
                                <div
                                    class="h-[14px] w-[14px] rounded-full border-2 border-warning-500">
                                </div>
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <div class="flex gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar1.png" alt="avatar-img"
                                                    class="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar2.png" alt="avatar-img"
                                                    class="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar3.png" alt="avatar-img"
                                                    class="avatar-img" />
                                            </div>
                                            <div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex gap-2">
                                            <div class="avatar avatar-circle">
                                                <img src="./images/avatar4.png" alt="avatar-img"
                                                    class="avatar-img" />
                                            </div>
                                            <div>
...
@push('per_page_js')
  <script src="{{ Vite::asset('resources/js/custom/analytics.js') }}" type="module"></script>
@endpush
