      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="code-viewer mt-4">
            <div class="flex flex-wrap gap-4">
              <div class="flex items-center gap-1.5">
                <input id="radio-primary" class="radio radio-primary" type="radio" name="radio-color" checked />
                <label for="radio-primary" class="label">Primary</label>
              </div>
              <div class="flex items-center gap-1.5">
                <input id="radio-secondary" class="radio radio-secondary" type="radio" name="radio-color" />
      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="code-viewer mt-4">
            <div class="flex flex-wrap gap-4">
              <div class="flex items-center gap-1.5">
                <input id="disabled" type="radio" class="radio" name="disabled-radio" disabled checked />
            ...
            <div class="mt-4 grid max-w-5xl grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
              <label for="custom-radio-card-startup" class="relative">
                ...
                <div class="absolute right-4 top-4 hidden h-5 w-5 peer-checked:block">
                  <i class="text-primary-600" data-feather="check-circle" height="100%" width="100%"></i>
                </div>
              </label>
              <label for="custom-radio-card-business" class="relative">
                <input
                  id="custom-radio-card-business"
                  class="zero-sr-only peer"
                  type="radio"
                  name="custom-radio-card"
                />
              ...
              <label for="custom-radio-card-enterprise" class="relative">
                <input
                  id="custom-radio-card-enterprise"
                  class="zero-sr-only peer"
                  type="radio"
                  name="custom-radio-card"
                />
