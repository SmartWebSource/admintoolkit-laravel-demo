...
<main class="container flex-grow p-4 sm:p-6">
          ...
          <div class="modal-body">
            <form id="form-add-event" class="space-y-4">
              ...
              <div class="flex w-full flex-col gap-4">
                <!-- Form Row: Title -->
                <div class="w-full">
                  <label class="label label-required mb-1" for="form-add-event-title"> Event Title </label>
                ...
                <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                  ...
                  <div class="w-full">
                    <label class="label label-required mb-1" for="form-add-event-end"> Event End Date </label>
                ...
                <div class="w-full">
                  <label class="label mb-1" for="form-add-event-description"> Event Description </label>
          ...
          <div class="modal-body">
            <form id="form-update-event" class="space-y-4">
              ...
              <div class="flex w-full flex-col gap-4">
                <!-- Form Row: Title -->
                <div class="w-full">
                  <label class="label label-required mb-1" for="form-update-event-title"> Event Title </label>
                  <input class="input" type="text" id="form-update-event-title" name="title" required />
                  <div class="error-message"></div>
                </div>
                <!-- Form Row: Start & End Date -->
                <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                  <!-- Form Column: Start Date -->
                  <div class="w-full">
                    <label class="label label-required mb-1" for="form-update-event-start" required>
                      Event Start Date
                    </label>
                    <input type="text" class="input" id="form-update-event-start" name="start" />
                    <div class="error-message"></div>
                  </div>
                  <!-- Form Column: End Date -->
                  <div class="w-full">
                    ...
                    <input type="text" class="input" id="form-update-event-end" name="end" required />
                    <div class="error-message"></div>
                  </div>
                </div>
                <!-- Form Row: Toggle All Day -->
                ...
                <div class="w-full">
                  ...
                  <input class="input" type="text" id="form-update-event-url" name="url" />
                </div>
                <!-- Form Row: Location -->
                <div class="w-full">
                  <label class="label mb-1" for="form-update-event-location"> Event Location </label>
                  <input class="input" type="text" id="form-update-event-location" name="location" />
                </div>
                <!-- Form Row: Description -->
                <div class="w-full">
                  <label class="label mb-1" for="form-update-event-description"> Event Description </label>
                  <textarea class="textarea" id="form-update-event-description" name="description"></textarea>
                </div>
              </div>
              <!-- Form Footer -->
              <div class="flex w-full items-center justify-between py-2">
                <button id="btn-delete-event" type="button" class="btn btn-soft-danger">Delete</button>
    ...
    <!-- Modal Update Event Ends -->
  </main>
@endsection


@push('per_page_js')
    <script src="{{ Vite::asset('resources/js/custom/calendar.js') }}" type="module"></script>
@endpush
