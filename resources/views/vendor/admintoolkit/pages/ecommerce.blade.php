                ...
                <div id="sales-report-chart-legend" class="flex items-center gap-4">
                  ...
                  <label for="profit">
                    ...
                    <div class="flex items-center gap-1">
                      ...
                      <span class="text-sm font-medium text-slate-600 dark:text-slate-300">Profit</span>
                    </div>
                  </label>
                </div>
                <!-- Select By Chart -->
        ...
        <div class="card col-span-1">
          <div class="card-body flex flex-col items-center justify-between">
            ...
            <div class="flex items-center gap-2">
              ...
              <div class="flex cursor-default items-center gap-1.5">
                <span class="inline-block h-[10px] w-[10px] rounded-full bg-slate-200 dark:bg-slate-600"></span>
                <div>
                            ...
                            <ul class="dropdown-list">
                              <li class="dropdown-list-item">
                                <a href="javascript:void(0)" class="dropdown-link">
                                  <i class="h-5 text-slate-500" data-feather="external-link"></i>
                                  <span>Details</span>
                                </a>
                              </li>
                              <li class="dropdown-list-item">
                                <a href="javascript:void(0)" class="dropdown-link">
                                  <i class="h-5 text-slate-500" data-feather="file-text"></i>
                                  <span>Invoice</span>
                                </a>
                              </li>
                              <li class="dropdown-list-item">
                    ...
                    <td>
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="whitespace-nowrap text-xs text-slate-400">Electronics > Accessories</p>
                        </div>
                      </div>
                    </td>
                    <td>APLW001</td>
                    ...
                    <td>
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="whitespace-nowrap text-xs text-slate-400">Electronics > Gadget</p>
                        </div>
                      </div>
                    </td>
                    <td>WLHP008</td>
                    ...
                    <td>
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="whitespace-nowrap text-xs text-slate-400">Electronics > Laptop</p>
                        </div>
                      </div>
                    </td>
                    <td>MBP098</td>
                    ...
                    <td>
                      <div class="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p class="whitespace-nowrap text-xs text-slate-400">Electronics > Mobile</p>
                        </div>
                      </div>
                    </td>
                    <td>IP13P</td>
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="flex items-center text-xs font-medium text-success-500"
                        ><i class="h-3 w-3" stroke-width="3px" data-feather="arrow-up-right"></i>3.5%</span
                      >
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <span class="flex items-center text-xs font-medium text-success-500"
                        ><i class="h-3 w-3" stroke-width="3px" data-feather="arrow-up-right"></i>1.5%</span
                      >
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <span class="flex items-center text-xs font-medium text-danger-500"
                        ><i class="h-3 w-3" stroke-width="3px" data-feather="arrow-down-left"></i>2.0%</span
                      >
                    </td>
                  </tr>
                </tbody>
