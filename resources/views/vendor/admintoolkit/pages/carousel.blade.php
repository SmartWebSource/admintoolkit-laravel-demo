              ...
              <div class="mx-auto max-w-5xl">
                ...
                <div class="swiper swiper-preview mt-4">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" role="group" aria-label="1 / 5">
                      <img
                        class="h-full max-h-20 w-full object-cover object-center"
                        src="./images/swiper-slide-1.jpg"
                        alt=""
                      />
                    </div>
                    ...
                    <div class="swiper-slide" role="group" aria-label="1 / 5">
                      ...
                      >
                        ...
                        <p class="hidden text-xs font-medium text-slate-200 sm:block">
                          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Doloremque, dolor vitae?
                          Minima blanditiis tempore quis, numquam dolorem laudantium quam illo in reiciendis,
              ...
              <div class="mx-auto max-w-5xl">
                <div class="swiper swiper-custom">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide" role="group" aria-label="1 / 5">
                      <img
                        class="h-full max-h-96 w-full object-cover object-top"
                        src="./images/swiper-slide-1.jpg"
                        alt="Swiper Slide 1"
                      />
                    </div>
