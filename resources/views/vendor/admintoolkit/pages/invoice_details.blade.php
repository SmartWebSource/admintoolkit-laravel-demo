                        ...
                        <td>
                          <div class="flex items-center gap-2">
                            ...
                            <div class="flex flex-col items-start justify-center">
                              <p class="text-sm font-medium text-slate-700 dark:text-slate-300">Product One</p>
                      ...
                      <tr>
                        <td>
                          <div class="flex items-center gap-2">
                            ...
                            />
                            <div class="flex flex-col items-start justify-center">
                              <p class="text-sm font-medium text-slate-700 dark:text-slate-300">Product Two</p>
                        ...
                        <td>
                          <div class="flex items-center gap-2">
                            <img
                              ...
                              class="h-12 w-12 rounded-primary"
                              alt="product-img"
                            />
                            <div class="flex flex-col items-start justify-center">
