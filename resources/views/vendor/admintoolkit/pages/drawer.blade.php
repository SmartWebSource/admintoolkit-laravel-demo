            ...
            <div id="drawer-basic" class="drawer">
              ...
              <div class="drawer-body">
                <p class="text-sm text-slate-600 dark:text-slate-300">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt iure tempora a blanditiis
                  inventore voluptatibus cupiditate, consectetur maiores architecto deleniti omnis voluptatem
          ...
          <div class="code-viewer mt-4">
            <div class="code-viewer-content">
              <div class="flex flex-wrap gap-2">
                <button class="btn btn-primary" type="button" data-toggle="drawer" data-target="#drawer-left">
                  Open from Left
                </button>
                <button class="btn btn-primary" type="button" data-toggle="drawer" data-target="#drawer-right">
                  Open from Right
                </button>
                <button class="btn btn-primary" type="button" data-toggle="drawer" data-target="#drawer-top">
                  Open from Top
                </button>
                <button class="btn btn-primary" type="button" data-toggle="drawer" data-target="#drawer-bottom">
                  Open from Bottom
                </button>
              </div>
                ...
                <div class="container">
                  ...
                  <div class="drawer-body">
                    <p class="text-sm text-slate-600 dark:text-slate-300">
                      ...
                      blanditiis inventore voluptatibus cupiditate, consectetur maiores architecto deleniti
                      omnis voluptatem facilis officiis odio harum quasi quae atque necessitatibus.
                    </p>
                  </div>
                  <div class="drawer-footer">
                    <div class="flex justify-end gap-2">
                      <button type="button" class="btn btn-secondary" data-dismiss="drawer">Cancel</button>
