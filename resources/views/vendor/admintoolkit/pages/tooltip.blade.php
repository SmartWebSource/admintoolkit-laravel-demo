          ...
          <div class="code-viewer mt-4">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
              ...
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="shift-away-subtle"
                data-tippy-content="I am a tippy tooltip!"
              >
                Shift Away Subtle
              </button>
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="shift-away-extreme"
                data-tippy-content="I am a tippy tooltip!"
              >
                Shift Away Extreme
              </button>
              ...
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="shift-toward-subtle"
                data-tippy-content="I am a tippy tooltip!"
              >
                Shift Toward Subtle
              </button>
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="shift-toward-extreme"
                data-tippy-content="I am a tippy tooltip!"
              >
              ...
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="scale-extreme"
                data-tippy-content="I am a tippy tooltip!"
              >
                Scale Extreme
              </button>
              ...
              <button
                ...
                class="btn btn-lg btn-primary"
                data-tooltip="tippy"
                data-tippy-animation="perspective-subtle"
                data-tippy-content="I am a tippy tooltip!"
              >
                Perspective Subtle
              </button>
        ...
        <div class="card-body">
          ...
          <div class="code-viewer mt-4">
            <button
              ...
              class="btn btn-primary"
              data-tooltip="tippy"
              data-tippy-content="I am a <strong>tippy</strong> tooltip!"
        ...
        <div class="card-body">
          ...
          <div id="custom-tooltip-code-viewer" class="code-viewer mt-4" data-render-source="false">
            <div class="code-viewer-content">
              <button id="btn-custom-tooltip" type="button" class="btn btn-primary">Custom Tooltip</button>
            </div>
          </div>
        </div>
      </div>
