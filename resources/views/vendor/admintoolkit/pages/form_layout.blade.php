            ...
            >
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="w-full">
                  ...
                  <input class="input" id="form-basic-email" name="email" type="text" placeholder="Email" />
                </div>
                <!-- Form Row: Phone -->
                <div class="w-full">
                  <label class="label label-required mb-1" for="form-basic-phone"> Phone </label>
                  <input class="input" id="form-basic-phone" name="phone" type="text" placeholder="Phone" />
                </div>
                <!-- Form Row: Message -->
                <div class="w-full">
                ...
                <div class="w-full">
                  <div class="flex items-center gap-1.5">
                    ...
                    <label class="label" for="form-basic-tos">
                      I agree with the
                      <a
                        class="text-primary-500 transition-colors duration-150 hover:text-primary-600 hover:underline focus:text-primary-600 focus:outline-none"
                        href="#"
                        target="_blank"
                      >
                        term of services
          ...
          <div class="code-viewer mt-4">
            ...
            >
              ...
              <div class="flex flex-col gap-4">
                ...
                <!-- Form Row: Post title -->
                <div class="w-full">
                  <label class="label label-required mb-1" for="form-with-dropzone-title"> Post title </label>
                  <input
                    class="input"
                    id="form-with-dropzone-title"
                    name="title"
                    type="text"
              ...
              <div class="flex flex-col gap-4">
                ...
                <div class="flex w-full flex-col items-center gap-1 md:flex-row md:gap-2">
                  <div class="w-full md:w-1/4">
                    <label class="label label-required" for="form-horizontal-full-name"> Full name </label>
                  </div>
                  <div class="w-full md:w-3/4">
                    <input
                      class="input"
                      id="form-horizontal-full-name"
                      name="full-name"
                      type="text"
                      placeholder="Full name"
                    />
                ...
                <div class="flex w-full flex-col items-center gap-1 md:flex-row md:gap-2">
                  <div class="w-full md:w-1/4">
                    <label class="label label-required" for="form-horizontal-company"> Company </label>
                  </div>
                  <div class="w-full md:w-3/4">
                    <input
                      class="input"
                      id="form-horizontal-company"
                      name="company"
                      type="text"
                      placeholder="Company"
                    />
                ...
                <div class="flex w-full flex-col items-center gap-1 md:flex-row md:gap-2">
                  <div class="w-full self-start md:w-1/4">
                    <label class="label label-required mt-2" for="form-horizontal-message"> Message </label>
                  </div>
                  <div class="w-full md:w-3/4">
                    <textarea
                      class="textarea"
                      name="message"
                      id="form-horizontal-message"
                      placeholder="Message"
                    ></textarea>
                  </div>
                </div>
                ...
                <div class="flex flex-col gap-4">
                  ...
                  <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                    ...
                    <div class="w-full md:w-1/2">
                      <label class="label label-required mb-1" for="form-with-multiple-column-username">
                        Username
                      </label>
                      <input
                        class="input"
                        id="form-with-multiple-column-username"
                        name="username"
                        type="text"
                    ...
                    <!-- Form Column: Email -->
                    <div class="w-full md:w-1/2">
                      <label class="label label-required mb-1" for="form-with-multiple-column-email">
                        Email
                      </label>
                      <input
                        class="input"
                        id="form-with-multiple-column-email"
                        name="email"
                        type="text"
                        placeholder="Email"
                      />
                  ...
                  <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                    ...
                    <div class="w-full md:w-1/2">
                      <label class="label label-required mb-1" for="form-with-multiple-column-password">
                        Password
                      </label>
                      <div class="input-group">
                        <input
                          class="input"
                          id="form-with-multiple-column-password"
                          name="password"
                          type="password"
                    ...
                    <div class="w-full md:w-1/2">
                      <label class="label label-required mb-1" for="form-with-multiple-column-confirm-password">
                        Confirm Password
                      </label>
                      <div class="input-group">
                        <input
                          class="input"
                          id="form-with-multiple-column-confirm-password"
            ...
            <div class="code-viewer-content overflow-visible">
              <div class="min-w-[26rem] max-w-full rounded-primary bg-white shadow dark:bg-slate-800">
                <div class="tabs">
                  <ul class="tabs-list">
                    <li class="tabs-item">
                      <button class="tabs-btn active" data-panel-id="#tabs-panel-personal-info" type="button">
                        Personal Info
                      </button>
                    </li>
                    <li class="tabs-item">
                      <button class="tabs-btn" data-panel-id="#tabs-panel-account-info" type="button">
                        Account Info
                      </button>
                    </li>
                    <li class="tabs-item">
                      <button class="tabs-btn" data-panel-id="#tabs-panel-social-info" type="button">
                        Social Info
                      </button>
                    </li>
                  </ul>
                      ...
                      <form id="form-personal-info" class="max-w-full p-4" action="">
                        ...
                        <div class="flex flex-col gap-4">
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            ...
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-personal-info-first-name">
                                First name
                              </label>
                              <input
                                class="input input-md"
                                id="form-personal-info-first-name"
                                name="first-name"
                                type="text"
                            ...
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-personal-info-last-name">
                                Last name
                              </label>
                              <input
                                class="input"
                                id="form-personal-info-last-name"
                                name="last-name"
                                type="text"
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            <!-- Form Column: Country -->
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-personal-info-country">
                                Country
                              </label>
                              <select class="tom-select" name="country" id="form-personal-info-country">
                      ...
                      <form id="form-account-info" class="max-w-full p-4" action="">
                        ...
                        <div class="flex flex-col gap-4">
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            <!-- Form Column: Username -->
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-account-info-username">
                                Username
                              </label>
                              <input
                                class="input"
                                id="form-account-info-username"
                                name="username"
                                type="text"
                                placeholder="Username"
                              />
                            ...
                            <!-- Form Column: Email -->
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-account-info-email">
                                Email
                              </label>
                              <input
                                class="input"
                                id="form-account-info-email"
                                name="email"
                                type="text"
                                placeholder="Email"
                              />
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            <!-- Form Column: Password -->
                            <div class="w-full md:w-1/2">
                              <label class="label label-required mb-1" for="form-account-info-password">
                                Password
                              </label>
                              <div class="input-group">
                                <input
                                  class="input"
                                  id="form-account-info-password"
                                  name="password"
                                  type="password"
                                  placeholder="Password"
                                />
                            ...
                            <!-- Form Column: Confirm Password -->
                            <div class="w-full md:w-1/2">
                              <label class="label mb-1" for="form-account-info-confirm-password">
                                Confirm Password
                              </label>
                              <div class="input-group">
                                <input
                      ...
                      <form id="form-social-info" class="max-w-full p-4" action="">
                        ...
                        <div class="flex flex-col gap-4">
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            <!-- Form Column: Twitter -->
                            <div class="w-full md:w-1/2">
                              <label class="label mb-1" for="form-social-info-twitter"> Twitter </label>
                              <input
                                class="input"
                                id="form-social-info-twitter"
                                name="twitter"
                                type="text"
                            ...
                            <div class="w-full md:w-1/2">
                              <label class="label mb-1" for="form-social-info-facebook"> Facebook </label>
                              <input
                                class="input"
                                id="form-social-info-facebook"
                                name="facebook"
                                type="text"
                          ...
                          <div class="flex w-full flex-col items-center gap-4 md:flex-row">
                            ...
                            <div class="w-full md:w-1/2">
                              <label class="label mb-1" for="form-social-info-instagram"> Instagram </label>
                              <input
                                class="input"
                                id="form-social-info-instagram"
                                name="instagram"
                                type="text"
                            ...
                            <div class="w-full md:w-1/2">
                              <label class="label mb-1" for="form-social-info-linkedin"> Linkedin </label>
                              <input
                                class="input"
                                id="form-social-info-linkedin"
                                name="linkedin"
                                type="text"
