...
<main class="container flex-grow p-4 sm:p-6">
    ...
    <div class="flex items-center justify-between">
      <div class="flex flex-col gap-1">
        <div>
          <a
            class="flex items-center gap-0 text-slate-400 transition duration-150 ease-in-out hover:text-primary-500"
            href="#"
          >
              ...
              <table class="table shadow-none">
                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="flex items-center gap-2">
                        <img src="./images/product1.png" class="h-12 w-12 rounded-primary" alt="product-img" />
                    ...
                    <td>
                      <p class="text-right text-sm font-normal text-slate-400 dark:text-slate-400">$24.00</p>
                    </td>
                    <td>
                      <p class="text-right text-sm font-normal text-slate-400 dark:text-slate-400">1 pcs</p>
                    </td>
                    <td>
                      <p class="text-right text-sm font-semibold text-slate-700 dark:text-slate-200">$24.00</p>
                    </td>
                  </tr>
                  <tr>
                    <td>
                      <div class="flex items-center gap-2">
                        <img src="./images/product2.png" class="h-12 w-12 rounded-primary" alt="product-img" />
                        <div class="flex flex-col items-start justify-center">
                  ...
                  <tr>
                    <td>
                      <div class="flex items-center gap-2">
                        <img src="./images/product3.png" class="h-12 w-12 rounded-primary" alt="product-img" />
                        <div class="flex flex-col items-start justify-center">
                          <h4 class="m-0 p-0 text-sm font-medium text-slate-700">Product Three</h4>
                          <p class="text-xs font-normal text-slate-400 dark:text-slate-400">
                            Delivery Date: 31/01/3023
                          </p>
                        </div>
              ...
              <div class="my-2 flex items-center justify-between">
                <div class="w-2/3 px-6 pb-2">
                  <div class="flex flex-col gap-1 py-4">
                    ...
                    <div class="flex items-center gap-1">
                      <img src="./images/icon-visa.png" class="h-6 w-6" alt="visa-img" />
                      <p class="text-sm font-medium text-slate-700 dark:text-slate-300">**** **** **** 4567</p>
                    </div>
                  </div>
            ...
            <table class="table min-w-[37rem]">
              ...
              <tbody>
                <tr>
                  <td>
                    <div class="flex items-center gap-2">
                      <img src="./images/Fedex.png" class="w-20" alt="carrier-img" />
                      <div class="flex flex-col items-start justify-center">
                  ...
                  <td>
                    <p class="text-right text-sm font-normal text-slate-400 dark:text-slate-400">2 pcs</p>
                  </td>
                  <td>
                    <p class="text-right text-sm font-semibold text-slate-700 dark:text-slate-200">$48.00</p>
                  </td>
                  <td>
                ...
                <tr>
                  <td>
                    <div class="flex items-center gap-2">
                      <img src="./images/Dhl.png" class="w-20" alt="carrier-img" />
                      <div class="flex flex-col items-start justify-center">
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="card w-full overflow-auto p-6">
            <div class="flex w-full">
              <!-- Line  -->
              <div class="mb-6 mt-6 w-1 border-r border-slate-300 dark:border-slate-600 md:mb-3 md:mt-3"></div>
              <!-- Order Items Start -->
              <div class="flex w-full flex-col items-center gap-8 md:gap-11">
                <div class="relative w-full">
                  ...
                  >
                    <i
                      class="h-4 w-4 rounded-full bg-success-500 p-[2px] text-slate-100"
                      stroke-width="3px"
                      data-feather="check"
                    ></i>
                  </div>
                  ...
                  >
                    <div class="flex flex-col gap-1 px-4 md:gap-0 md:px-5">
                      <h4 class="text-sm font-medium text-slate-700 dark:text-slate-200">Order Placed</h4>
                ...
                <div class="relative w-full">
                  ...
                  >
                    ...
                    <div class="flex items-center px-4 md:px-0">
                      <img src="./images/Dhl.png" class="w-20" alt="dhl-img" />
                    </div>
                  </div>
                </div>
                <div class="relative w-full">
                ...
                <div class="relative w-full">
                  ...
                  >
                    <i
                      class="h-4 w-4 rounded-full bg-slate-400 p-[2px] text-slate-100"
                      stroke-width="3px"
                      data-feather="check"
                    ></i>
                  </div>
      ...
      <div class="h-full py-2 lg:col-span-1">
        <div class="sticky top-20 min-h-max rounded-primary bg-white shadow dark:bg-slate-800">
          ...
          <div class="flex items-center gap-2 border-b border-slate-200 px-6 py-4 dark:border-slate-700">
            <img src="./images/avatar1.png" class="h-10 w-10 rounded-full" alt="avatar-img" />
